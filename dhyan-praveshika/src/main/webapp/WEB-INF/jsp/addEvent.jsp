...
if ( window.history.replaceState ) {
  window.history.replaceState( null, null, '/dhyanpraveshika-web/getEventPage' );
}
</script>
  ...
  <div class="modal fade" id="editAddEventModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <form action="/dhyanpraveshika-web/addEvent"  method="post" enctype="multipart/form-data" id="addEditEvent">
